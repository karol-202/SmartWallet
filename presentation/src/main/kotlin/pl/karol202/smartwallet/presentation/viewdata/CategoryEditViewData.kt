...
fun CategoryEditViewData.toEntity() = Category(New, name, type.toEntity(), false)

fun CategoryEditViewData.toEntity(id: String) = Category(id.asId(), name, type.toEntity(), false)
