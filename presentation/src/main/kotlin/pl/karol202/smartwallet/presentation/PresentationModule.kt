...
import pl.karol202.smartwallet.presentation.viewmodel.accountsedit.AccountEditViewModelImpl
...
fun presentationModule() = module {
	...
	factory<AccountsViewModel> { AccountsViewModelImpl(get(), get()) }
	factory<AccountEditViewModel> { AccountEditViewModelImpl(get(), get(), get(), get(), get(), get()) }
}
