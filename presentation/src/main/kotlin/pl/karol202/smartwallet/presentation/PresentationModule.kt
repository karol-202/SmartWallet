...
fun presentationModule() = module {
	...
	factory<TransactionEditViewModel> { TransactionEditViewModelImpl(get(), get(), get(), get(), get()) }
	...
	factory<SubcategoryEditViewModel> { SubcategoryEditViewModelImpl(get(), get(), get(), get(), get()) }
}
